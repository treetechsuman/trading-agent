"""Yearly breakdown for wm_fix_reversal v1 (locked MinSpikeSizePips=12) --
checking whether the edge holds year over year across the in-sample range
(2018-2022), or is concentrated in one favorable year."""
import csv
import subprocess
import sys
